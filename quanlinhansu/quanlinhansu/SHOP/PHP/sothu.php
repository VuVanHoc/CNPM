...
<body>
	<div class="container-fluid">
		<div class="row text-center" style="border-bottom: 1px solid #ccc; background: #d6e4e6; height: 100px;">
			...
			<div class="col-md-10">
				<button class="btn btn-secondary" style="font-size: 18px; font-family: cursive; margin-top: 32px; margin-left: -220px;">SỐ THU</button>
			</div>
		</div>
		<div class="row" style="margin-top: 40px; padding-left: 280px;">
			...
			<div class="row" style="margin-top: 40px; margin-left: 850px;">
				<div class="col-md-8">
					<form method="POST">
						<input type="submit" name="submit" value="Tổng thu" class="btn btn-secondary">
					</form>
				</div>
				<div class="col-md-4" style="margin-left: -215px; margin-top: 7px;">
					<?php 
						...
						{
							$sql1 = "SELECT SUM(soluongban*dongia) AS total FROM donhang";
